...
esar = {                                                                                                                 // 4
  ...
  error: {                                                                                                             //
    ...
    accounts: {                                                                                                        //
      ...
      "Invalid login token": "Token de inicio de sesión invalida",                                                     //
      ...
      "No matching login attempt found": "Ningún intento de inicio de sesión coincidente se encuentra",                //
      "Password is old. Please reset your password.": "Contraseña es vieja. Por favor resetear la contraseña.",        //
...
T9n.map ("esar", esar);    
 ...
 T9n.setLanguage('esar');
 console.log(T9n.getLanguage ());